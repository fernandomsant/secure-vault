CREATE TABLE users (
    ...
    user_insert_datetime DATETIME NOT NULL DEFAULT SYSUTCDATETIME()
);
...
CREATE TABLE files (
    ...
    file_insert_datetime DATETIME NOT NULL DEFAULT SYSUTCDATETIME(),
...
CREATE TABLE tokens (
    ...
    token_insert_datetime DATETIME NOT NULL DEFAULT SYSUTCDATETIME(),
