...
class User(Base):
    ...
    user_is_active = Column(Boolean, nullable=False, default=True, server_default=text("1"))
...
class Token(Base):
    ...
    token_is_active = Column(Boolean, nullable=False, default=True, server_default=text("1"))
