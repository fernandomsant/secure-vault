...
class File(Base):
    ...
    file_file_extension = Column(String(10), nullable=False)
    file_description = Column(String(200), nullable=True)
...
class Token(Base):
    ...
    token_is_active = Column(Boolean, nullable=False, default=True)
